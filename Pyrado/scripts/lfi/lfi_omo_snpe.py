...
if __name__ == '__main__':
    ...
    # train the posterior
    posterior = train_lfi(simulator, inference, prior, x_o, num_sim=10, num_rounds=2)

    # generate examples from the posterior
    proposals, log_prob, trajectories = evaluate_lfi(simulator=simulator, posterior=posterior, x_o=x_o)
